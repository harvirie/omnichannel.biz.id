...
@media(max-width:767px){
  /* Mobile: hide label text, show icon only */
  #omni-lc-toggle{padding:8px;border-radius:50%;width:52px;height:52px;justify-content:center;}
  #omni-lc-toggle-icon{width:36px;height:36px;}
  #omni-lc-toggle-icon img{width:24px;height:24px;}
  #omni-lc-toggle-label{display:none;}
...
function appendMsg(sender, text, time, meta, id) {
    ...
    if(isUser) {
        ...
        wrap.innerHTML=`<div style="display:flex;flex-direction:column;align-items:flex-end;">
            ...
            <div class="lc-msg-time" style="text-align:right;">${time}</div></div>`;
    } else {
...
if(sessionKey){ formWrap.style.display='none'; chatWrap.style.display='flex'; statusTxt.textContent='🟢 Online'; startPoll(); }
