...
class Omni_Animations {
    ...
    public function enqueue_assets() {
        ...
        // Custom Assets
        wp_enqueue_style('omni-animations-css', plugin_dir_url(__FILE__) . 'assets/omni-animations.css', [], '2.1.1');
        wp_enqueue_script('omni-animations-js', plugin_dir_url(__FILE__) . 'assets/omni-animations.js', array('omni-scrolltrigger', 'omni-swup-body-class'), '2.1.1', true);
    }
}
