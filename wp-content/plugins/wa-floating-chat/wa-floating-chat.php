...
function wa_floating_chat_render_widget() {
    ...
    #wa-toggle-btn{background:#25D366;color:white;border-radius:9999px;width:58px;height:58px;border:none;box-shadow:0 4px 14px rgba(0,0,0,.12);cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:all .2s;touch-action:manipulation;-webkit-tap-highlight-color:transparent;}
