...
function wa_floating_chat_render_widget() {
    ...
    <div id="wa-widget" style="position:fixed;bottom:24px;right:24px;z-index:99997;display:flex;flex-direction:column;align-items:flex-end;font-family:ui-sans-serif,system-ui,sans-serif;">
      <div id="wa-form-container" style="display:none;background:white;border-radius:16px;box-shadow:0 20px 25px -5px rgba(0,0,0,.15);border:1px solid #e5e7eb;width:320px;margin-bottom:80px;overflow:hidden;opacity:0;transition:opacity .3s ease;">
      ...
      <button id="wa-toggle-btn" style="background:#25D366;color:white;border-radius:9999px;width:58px;height:58px;border:none;box-shadow:0 4px 14px rgba(0,0,0,.12);cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:all .2s;">
