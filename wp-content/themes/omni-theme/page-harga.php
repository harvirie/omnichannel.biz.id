...
<div class="flex-1 bg-white w-full">
  ...
  <div class="-mt-20 md:-mt-32 pt-40 md:pt-52 hero-wrap" style="background-color: #f1f5f9;">
    ...
    <div class="hero-illustration-container w-full">
      <!-- SVG ditempatkan absolute di atas gambar —jadi tidak ada celah antar elemen -->
      ...
      <!-- WebP dengan fallback PNG -->
      <picture>
        <source srcset="<?php echo get_template_directory_uri(); ?>/assets/img/harga-hero-updated.webp" type="image/webp">
        <img
          src="<?php echo get_template_directory_uri(); ?>/assets/img/harga-hero-updated.png"
          alt="Daftar Paket Harga OmniServe — Paket Standard dan Professional Plus dengan VoIP PSTN"
