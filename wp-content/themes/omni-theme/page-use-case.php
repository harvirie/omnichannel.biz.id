  ...
  <div class="-mt-20 md:-mt-32 pt-40 md:pt-52 hero-wrap" style="background-color: #f1f5f9;">
    <div class="max-w-7xl mx-auto px-6 text-center relative z-10" style="padding-bottom: 100px;">
      ...
      <p class="text-omni-text-muted text-lg md:text-xl max-w-2xl mx-auto">
        Dari WhatsApp Unlimited hingga Telepon PSTN dengan Recording &mdash; pelajari bagaimana fitur-fitur nyata kami menyelesaikan tantangan nyata di lapangan.
      </p>
    </div>
    <!-- Background shapes -->
    ...
    <div class="hero-illustration-container w-full">
      ...
      <picture>
        <source srcset="<?php echo get_template_directory_uri(); ?>/assets/img/usecase-hero-updated.webp" type="image/webp">
        <img
