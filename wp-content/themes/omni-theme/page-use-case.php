...
<div class="flex-1 bg-white w-full">
  <!-- Header Area -->
  <div class="bg-[#7A9E7E] py-24 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6 text-center relative z-10">
      <h1 class="text-4xl md:text-5xl font-bold text-white mb-6 drop-shadow-sm">
        Solusi <span class="text-[#FDB854]">Untuk Setiap Industri</span>
      </h1>
      <p class="text-[#EBF4E3] text-lg md:text-xl max-w-2xl mx-auto drop-shadow-sm">
    ...
    <div class="absolute bottom-10 right-10 w-80 h-80 bg-[#1C2C1F]/20 rounded-full blur-3xl"></div>
  </div>
  ...
  <section class="py-20">
    <div class="max-w-7xl mx-auto px-6">
      <div class="grid md:grid-cols-2 gap-12">
        ...
        <!-- E-Commerce -->
        <div class="flex flex-col md:flex-row gap-6 bg-[#F4F9F0] p-8 rounded-3xl border border-[#d2e3c9]">
          <div class="shrink-0 bg-white p-4 rounded-2xl shadow-sm h-fit">
            <i data-lucide="shopping-bag" class="w-10 h-10 text-[#FDB854]"></i>
          </div>
          <div>
            <h3 class="text-2xl font-bold text-[#1C2C1F] mb-3">E-Commerce & Ritel</h3>
            <p class="text-[#4F6854] mb-4">
            ...
            <ul class="list-disc list-inside text-[#415B45] space-y-1 ml-4 text-sm font-medium">
        ...
        <div class="flex flex-col md:flex-row gap-6 bg-[#F4F9F0] p-8 rounded-3xl border border-[#d2e3c9]">
          <div class="shrink-0 bg-white p-4 rounded-2xl shadow-sm h-fit">
            <i data-lucide="building-2" class="w-10 h-10 text-[#415B45]"></i>
          </div>
          <div>
            <h3 class="text-2xl font-bold text-[#1C2C1F] mb-3">Layanan Keuangan</h3>
            <p class="text-[#4F6854] mb-4">
        ...
        <div class="flex flex-col md:flex-row gap-6 bg-[#F4F9F0] p-8 rounded-3xl border border-[#d2e3c9]">
          <div class="shrink-0 bg-white p-4 rounded-2xl shadow-sm h-fit">
            <i data-lucide="stethoscope" class="w-10 h-10 text-[#7A9E7E]"></i>
          </div>
          <div>
            <h3 class="text-2xl font-bold text-[#1C2C1F] mb-3">Layanan Kesehatan</h3>
            <p class="text-[#4F6854] mb-4">
        ...
        <div class="flex flex-col md:flex-row gap-6 bg-[#F4F9F0] p-8 rounded-3xl border border-[#d2e3c9]">
          <div class="shrink-0 bg-white p-4 rounded-2xl shadow-sm h-fit">
            <i data-lucide="briefcase" class="w-10 h-10 text-[#1C2C1F]"></i>
          </div>
          <div>
            <h3 class="text-2xl font-bold text-[#1C2C1F] mb-3">Layanan B2B</h3>
            <p class="text-[#4F6854] mb-4">
  ...
  <!-- Mini CTA -->
  <section class="bg-[#1C2C1F] py-16 text-center border-t border-[#415B45]">
    <h2 class="text-2xl font-bold text-[#EBF4E3] mb-6">Punya studi kasus khusus?</h2>
    <a href="<?php echo home_url('/harga'); ?>" class="inline-block bg-[#FDB854] text-[#1C2C1F] px-8 py-3 rounded-full font-bold hover:bg-[#e89e3a] hover:text-white transition-colors shadow-lg">
